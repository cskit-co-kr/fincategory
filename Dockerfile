...
ENV NEXT_PUBLIC_AVATAR_URL=https://finca.co.kr
ENV NEXT_PUBLIC_API_URL=https://api.finca.co.kr
ENV NEXT_PUBLIC_BACKEND_URL=https://backend.finca.co.kr
ENV NEXT_PUBLIC_GA_MEASUREMENT_ID="G-3XWE84KEQ0"
ENV JWT_SECRET_KEY=9FZID6AKGFVV4J99T3HJ
...
ENV KAKAO_CLIENT_SECRET=15d7f66e31a6069527a4ed2c970e097c
ENV NEXT_LOCAL_API_URL=ws://localhost:8081
ENV NEXT_PUBLIC_IMAGE_URL=https://file.finca.co.kr
ENV IS_LOCAL=false
