        ...
        <div className="p-5 gap-3 border flex flex-col border-gray-200 rounded-md bg-white md:w-2/4 mx-auto mt-4">
          {resultState !== null ? (
            <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-md font-semibold justify-center">
              <CheckCircleIcon className="h-6 animate-ping" />
              {resultState}
            </div>
          ) : (
            ""
          ...
          {errorCountry !== null ? (
            <div className="text-red-500 -mt-3 italic">{errorCountry}</div>
          ) : (
            ""
          )}
          ...
          {errorLanguage !== null ? (
            <div className="text-red-500 -mt-3 italic">{errorLanguage}</div>
          ) : (
            ""
          )}
          ...
          {errorCategory !== null ? (
            <div className="text-red-500 -mt-3 italic">{errorCategory}</div>
          ) : (
            ""
          )}
          <button
