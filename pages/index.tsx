            ...
            <div className='flex border border-gray-200 rounded-md bg-white p-4'>
              <ul className='text-xs gap-0.5 flex flex-col'>
                <li className='flex gap-1'>
                  ...
                  <div className='truncate w-[230px] md:w-[260px] lg:w-[290px]'>조국 징역 클리앙 반응</div>
                  <div className='text-red-500'>[7]</div>
                </li>
                <li className='flex gap-1'>
                  <div className='text-gray-400 shrink-0'>&#9642; 2023-02-03</div>
                  <div className='truncate w-[230px] md:w-[260px] lg:w-[290px]'>[디지털페어] [COLORFUL] iGAME 지포스 RTX 3060 Ti Ultra</div>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 mt-4 gap-4'>
          {category?.map((category: any, index: number) => (
            <div key={index}>
              ...
              <div className='border border-gray-200 rounded-md bg-white p-4'>{<GetChannelsByCategory value={category.value} label={category.label} />}</div>
            </div>
          ))}
        </div>
      </div>
