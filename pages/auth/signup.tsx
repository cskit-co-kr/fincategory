...
const MemberSignUp = () => {
  ...
  const onSubmit = async (data: any) => {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_CLIENT_API_URL}/api/member?f=register`,
      {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify({
  ...
  return (
    <>
      ...
      />
      <div
        className="gap-4 pt-7 .h-[calc(100vh-250px)] flex items-center justify-center bg-gray-50
      Msm:px-[15px] Msm:py-[30px] Msm:my-[16px]"
      >
        <div className="w-full sm:w-[500px] mx-auto border border-gray-200 bg-white rounded-md p-[30px] shadow-sm">
