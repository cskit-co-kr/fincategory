          ...
          <div className='white-box'>
            ...
            <div className='mt-[30px] space-y-5'>
              <div className='flex items-center'>
                <div className='w-1/4 font-semibold'>상품명:</div>
              ...
              <div className='flex justify-center gap-4'>
                ...
                <dialog id='confirm' className='modal'>
                  <div className='modal-box max-w-2xl'>
                    <div className='text-xl font-bold text-center'>광고상품 구매</div>
                    <div className='grid grid-cols-2 border border-gray-200 rounded-lg mt-7'>
                      <div className='px-4 py-2.5 font-semibold border-b border-gray-200'>상품명:</div>
                      <div className='px-4 py-2.5 border-b border-gray-200'>메인 페이지에 채널 표시하기</div>
                      <div className='px-4 py-2.5 font-semibold border-b border-gray-200'>제품 가격:</div>
                      <div className='px-4 py-2.5 border-b border-gray-200'>200,000 핀코인</div>
                      <div className='px-4 py-2.5 font-semibold border-b border-gray-200'>텔레그램 채널 ID:</div>
                      <div className='px-4 py-2.5 border-b border-gray-200'>comaps</div>
                    </div>
                    <div className='modal-action'>
                      <form method='dialog'>
                        <button className='blue-button bg-white border-2 border-primary text-primary'>취소</button>
                      </form>
