          ...
          <div className="w-full xl:w-[974px] flex flex-col gap-4 justify-items-stretch content-start">
            ...
            <div className="w-full xl:w-[974px] mt-4 md:mt-0 gap-2 flex flex-col border border-gray-200 rounded-md p-5 pl-0 bg-white">
              <div className="ml-5 gap-4 items-center">
                ...
                <div className="flex gap-0.5 text-xs my-4 h-fit">
                  <button className={`rounded-md px-1 py-0.5 border hover:border-primary ${subscribersCountWMYA === "week" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersCountRange("week")}>
                    {t["Week"]}
                  </button>
                  <button className={`rounded-md px-1 py-0.5 border hover:border-primary ${subscribersCountWMYA === "month" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersCountRange("month")}>
                    {t["Month"]}
                  </button>
                  <button className={`rounded-md px-1 py-0.5 border hover:border-primary ${subscribersCountWMYA === "year" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersCountRange("year")}>
                    {t["Year"]}
                  </button>
                  <button className={`rounded-md px-1 py-0.5 border hover:border-primary whitespace-nowrap ${subscribersCountWMYA === "all" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersCountRange("all")}>
                    {t["All-time"]}
                  </button>
                </div>
              </div>
            ...
            <div className="w-full xl:w-[974px] mt-4 md:mt-0 gap-2 flex flex-col border border-gray-200 rounded-md p-5 pl-0 bg-white">
              ...
              <div className="flex gap-0.5 text-xs m-4 h-fit">
                <button className={`rounded-md px-1 py-0.5 border hover:border-primary ${subscribersGrowthWMYA === "week" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersGrowthRange("week")}>
                  {t["Week"]}
                </button>
                <button className={`rounded-md px-1 py-0.5 border hover:border-primary ${subscribersGrowthWMYA === "month" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersGrowthRange("month")}>
                  {t["Month"]}
                </button>
                <button className={`rounded-md px-1 py-0.5 border hover:border-primary ${subscribersGrowthWMYA === "year" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersGrowthRange("year")}>
                  {t["Year"]}
                </button>
                <button className={`rounded-md px-1 py-0.5 border hover:border-primary whitespace-nowrap ${subscribersGrowthWMYA === "all" ? "border border-primary bg-white" : "bg-gray-100"}`} onClick={() => setSubscribersGrowthRange("all")}>
                  {t["All-time"]}
                </button>
              </div>
              <ResponsiveContainer width="100%" height={420}>
            ...
            <div className="w-full mt-4 md:mt-0 gap-2 flex flex-col border border-gray-200 rounded-md p-5 bg-white">
              ...
              <div className="">
                ...
                {currentItems.map((item: any, index: number) => (
                  <div key={index} className="flex space-between w-full p-2.5 border-t">
                    ...
                    <div className={`basis-1/3 text-right pr-2 ${item.diff < 0 ? "text-red-400" : "text-green-500"}`}>
                      {item.diff}
                    </div>
                  </div>
                ))}
