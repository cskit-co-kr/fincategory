            ...
            <label className='flex flex-col gap-2'>{t['channels-age-from-months']}
                <Box className='pl-3 pr-6'>
                    <Slider
                        ...
                        onChange={(event: Event, newValue: number | number[]) => { setChannelsAge(newValue as number) }}
                        min={0}
                        max={36}
            ...
            <label className='flex flex-col gap-2'>{t['engagement-rate-erp']}
                <Box className='pl-3 pr-6'>
                    <Slider
                        ...
                        onChange={(event: Event, newValue: number | number[]) => { setChannelsERP(newValue as number) }}
                        min={0}
                        max={100}
