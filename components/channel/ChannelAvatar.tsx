...
const ChannelAvatar = ({ id, title, size, shape, type, showType, typeStyle, typeIcon }: any) => {
  ...
  return (
    <div className={`relative min-w-[${size}px] max-w-[${size}px]`}>
      ...
      {showType && (
        <div
          className={`text-[11px] mx-auto p-[2px] border-2 border-white rounded-full w-fit whitespace-nowrap text-white ${typeStyle} ${
