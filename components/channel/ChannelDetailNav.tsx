...
const ChannelDetailNav = ({ channel }: any) => {
  ...
  const aNormal =
    "py-2 px-3.5 hover:no-underline flex gap-2 items-center hover:text-white";
  return (
    <>
      <ul className="w-full text-[0.813rem] font-semibold flex gap-2 bg-[#f2f2f2] rounded-md p-2 mt-4 md:mt-0">
        <li
        ...
        >
          <a
            href={`${menuPath}channel/${channel.username}`}
            className={aNormal}
          >
        ...
        >
          <a
            href={`${menuPath}channel/${channel.username}/subscribers`}
            className={aNormal}
          >
        ...
        >
          <a
            href={`${menuPath}channel/${channel.username}/posts-views`}
            className={aNormal}
          >
        ...
        <li
          className={`rounded-lg ${
            router.pathname == "/channel/[id]/top-posts" ? liSelected : liNormal
          }`}
        >
          <a
            href={`${menuPath}channel/${channel.username}/top-posts`}
            className={aNormal}
          >
