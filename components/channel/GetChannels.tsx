...
const GetChannels: FunctionComponent<Props> = ({ channels }) => {
  ...
  return (
    <Link
      ...
      target={"_blank"}
    >
      <div className="flex items-start border border-gray-200 rounded-md bg-white p-4 gap-[10px] text-black max-h-[140px] overflow-hidden transition ease-in-out hover:border-gray-400 duration-300 hover:shadow-sm">
        ...
        <div className="flex flex-1 flex-col gap-2 overflow-hidden">
          ...
          <p className="text-[12px] h-9 w-full overflow-hidden">
