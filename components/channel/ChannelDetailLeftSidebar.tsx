  ...
  return (
    <div className='flex flex-col w-full md:w-[310px] mt-4 md:mt-0 md:mr-4 '>
      <div className='flex flex-col gap-4 border border-gray-200 rounded-md p-[30px] bg-white items-center'>
        ...
        <div className='flex flex-col justify-between w-full'>
          ...
          <span className='text-primary'>
            {channel.category && JSON.parse(channel.category.name)[locale]}
          </span>
        </div>
        <div className='flex flex-col justify-between w-full'>
      ...
      <div className='flex gap-4 border border-gray-200 rounded-md p-4 bg-white mt-4'>
        <ul className='w-full'>
          <li className='py-3 px-4 text-[0.813rem] font-semibold bg-[#F5F7F9] rounded-xl'>
            <a href='' className='hover:no-underline flex gap-2 items-center'>
              <RectangleGroupIcon className='h-3' />
              {t['Summary']}
            </a>
          </li>
          <li className='py-3 px-4 text-[0.813rem] font-semibold hover:bg-[#F5F7F9] rounded-xl'>
            <a
              href={`${router.asPath}/subscribers`}
              className='hover:no-underline flex gap-2 items-center'
            >
