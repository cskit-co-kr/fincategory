...
const SearchFilterBar = ({
  ...
  //           {icon && (
  //             <span className={`${isActive ? "text-white" : "text-[#3886E2]"}`}>
  //               {icon}
  //             </span>
  //           )}
  //           {label}
  ...
  return (
    <>
          ...
          >
            ...
            >
              <path
                ...
                // stroke="white"
                // stroke={`${viewPort === "grid" ? "1C1E21" : "white"}`}
      ...
      {/* <div className="flex items-center gap-[12px]">
        <button className="bg-primary">List</button>
        <button className="bg-primary">Card</button>
      </div> */}
    </>
  );
};
