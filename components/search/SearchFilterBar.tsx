      ...
      <div className='sorting flex items-center w-full bg-white md:rounded-xl p-3 md:p-4 border border-gray-200'>
        <div className='flex gap-2 items-center'>
          ...
          >
            <HiOutlineMegaphone
              size={16}
              className={`${channelType[0].value === "channel" ? "text-white" : "text-[#3886E2]"}`}
            />
            {t["channel"]}
          </button>
          <button
          ...
          >
            <HiOutlineUsers
              size={16}
              className={`${channelType[0].value === "public_group" ? "text-white" : "text-[#FF7171]"}`}
            />
            {t["Public Group"]}
          </button>
          <button
          ...
          >
            <HiOutlineLockClosed
              size={16}
              className={`${channelType[0].value === "private_group" ? "text-white" : "text-[#FF7171]"}`}
            />
            {t["Private Group"]}
          </button>
        </div>
      ...
      <div className='flex items-center p-4 md:p-0 gap-4'>
        <div className='text-sm'>
          {`${t["total-search-results1"]} ${
            selectedTag ? '"' + `#${selectedTag}` + '" ' : router.query.q ? router.query.q : ""
          }: `}
