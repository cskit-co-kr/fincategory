...
const AdChannel: FunctionComponent<Props> = ({ channel, showType }) => {
  ...
  const style =
    "p-4 border border-primary hover:shadow-sm transition ease-in-out duration-300";

  return (
    <div
      className={`${style} relative flex rounded-xl gap-2.5 text-black bg-white mx-4 md:mx-0`}
    >
      <Image
        src="/ad.png"
        alt=""
