      ...
      <div className="modal-box p-10 max-w-[475px]">
        ...
        <div className="mt-5 mx-auto grid space-y-6">
          <div className="space-y-2">
            <div className="font-semibold">{t["상품명"]}:</div>
            <div>
              <input
                className="border border-[#d9d9d9] rounded-md px-3 py-2 w-full"
                value={`${
                  adsGroup === "ads1" ? "최상단 배너" : "첫 페이지 노출"
                } ${data.duration}`}
                disabled
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 relative">
              <input
                className={`border rounded-md px-3 py-2 w-full ${
                  channelError ? "border-red-500" : "border-[#d9d9d9]"
                }`}
              ...
              {checkUsernameLoading && (
                <Loader className="absolute right-[90px] top-3 h-6" />
              )}
            ...
            {channelError && (
              <div className="text-red-500 italic text-xs">{channelError}</div>
            )}
          </div>
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                className={`border rounded-md px-3 py-2 w-full ${
                  lowBalance ? "border-red-500" : "border-[#d9d9d9]"
                }`}
                value={balance}
                disabled
              />
