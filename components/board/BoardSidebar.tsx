        ...
        <div className="lg:sticky lg:top-4">
          ...
          <div className="flex flex-col gap-2.5 border border-gray-200 rounded-lg p-[30px] bg-white mt-4">
            ...
            <div className="border-y border-gray-200 py-3 font-semibold">
              <Link
                href="/board"
                className={`${router.asPath === "/board" && "text-primary"}`}
              >
                {t["view-all-articles"]}
              </Link>
            </div>
                ...
                group.boards.map((board: any, key) => (
                  <Link
                    ...
                    className={`focus:no-underline py-1 items-center flex gap-2 ${
                      ...
                      router.query.id && postBoardName === board.name
                        ? "text-primary"
                        : ""
                    }`}
                  >
            ...
            <div className="bg-gray-100 p-4 text-xs hidden">
              {t["no-connected-members"]}
            </div>
            <div className="border border-gray-200 p-4 text-xs hidden">
              {t["today"]} 3 {t["All"]} 549
            </div>
          </div>
        </div>
