...
const CategoriesSection = ({
  ...
  return (
    <div
      className={`top-0 z-20 Mlg:px-[16px] ${
        mobileCategoryModal ? ".px-[16px]" : ""
      }  ${pageYOffset === false ? "" : `sticky`}`}
    >
      <div
        className={`white-box py-[0px] px-[20px] .border-none lg:border border-gray-secondary Mlg:px-[16px] transition-all transform duration-150 overflow-hidden h-fit ${
          pageYOffset === false
            ? ""
            : `overflow-hidden categorySec-boxShadow rounded-xl border-none`
        } Mlg:rounded-none Mlg:shadow-none  ${
          mobileCategoryModal ? "categorySec-boxShadow !rounded-xl" : ""
        } Mlg:!rounded-xl Mlg:!border Mlg:!border-[#F1F1F1] Mlg:!px-[15px]`}
      >
        <div
          ...
          >
            ...
            <div className="flex flex-row justify-end gap-[10px] w-full">
              ...
              <button
                ...
                ${pageYOffset === false && "hidden"} Mlg:hidden`}
                onClick={() => {
                  window.scrollTo({
                    top: 0,
                    behavior: "smooth",
