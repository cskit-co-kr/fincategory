...
const FixedBarSection = () => {
  ...
  return (
    <div
      className={` fixed hidden  z-40 top-1/2 -translate-y-1/2 right-5 2xl:right-[5%] lg:translate-y-0 lg:top-[113px] gap-3 w-[145px] p-3 transition-all shadow-xl items-center bg-white rounded-xl  lg:flex flex-col`}
    >
      <div
        className={` absolute lg:hidden top-1/2 -translate-y-1/2 bg-primary rounded-l-full px-1 py-2 text-white text-5xl right-full`}
      >
        <LuArrowBigLeft />
      </div>
